 ...
 */
exports.getTelemetryStream = (req, res) => {
 ...
 */
exports.getTelemetryStatus = (req, res) => {
 ...
 */
exports.configureSimulator = (req, res) => {
 ...
 */
exports.setTargetWeight = (req, res) => {
